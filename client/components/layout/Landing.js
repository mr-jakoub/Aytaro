            ...
            <div className="container">
                <section className="home">
                    ...
                    <div className="col-md-7 welcome">
                        ...
                        <p className="lead my-4">Aytaro will connect the teacher and his students, giving the opportunity to share new ideas.</p>
                        <div className="button">
                            <Link className="text-xs svg-icon" href="/register"><a>Let's get started&nbsp;&nbsp;
                    ...
                    <div className="col-md-5 right-sec">
                        <div className="new-users">
                            <div className="border">
                                <span>
                                    <img src={!users || users[0].avatar === "default" ? '/default/defaultProfile.png' : users[0].avatar} alt="user" />
                                </span>
                                <span>
                                    <img src={!users || users[0].avatar === "default" ? '/default/defaultProfile.png' : users[0].avatar} alt="user" />
                                </span>
                            ...
                            <div className="row">
                                <div className="col-sm-6 card">
                                    <div className="text-center">
                                        ...
                                        <p className="lead my-2">Aytaro. provides an opportunity to present and discuss various ideas.</p>
                                    </div>
                                </div>
                                <div className="col-sm-6 card">
                                    <div className="text-center">
                            ...
                            <div className="row">
                                <div className="col-3">
                                    <div className="avatar">
                                        <img src='/default/defaultProfile.png' alt="avatar" />
                                    </div>
                        ...
                        <div className="col-md-5 my-3">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-6 info">
                                    ...
                                    <p>
                                        <a className="lead svg-icon" href="mailto:help@Aytaro.com">
                ...
                <footer>
                    <div className="row">
                        <div className="col-md-3">
                            <h1 className="text-md"><Link className="logo" href="/"><a>Aytaro.</a></Link></h1>
                        </div>
                    </div>
                        ...
                        <div className="col-md-3 links">
                            <p className="text-xxs text-bold svg-icon SVG-container"><span id="language">English</span>&nbsp;
                                ...
                                <span className="languages">
                                    <Link className="lead" href="/ar"><a>&nbsp;العربية</a></Link>
                                    <Link className="lead" href="/en"><a>&nbsp;English</a></Link>
                                    <Link className="lead" href="/fr"><a>&nbsp;Francais</a></Link>
                                </span>
                            </p><br/>
                            <p className="text-xxs text-bold"><Link href="/security"><a>Security</a></Link></p>
                        </div>
                        <div className="col-md-3 links">
                            <p className="text-xxs text-bold"><Link href="/help"><a>Help Centrer</a></Link></p><br/>
                            <p className="text-xxs text-bold"><Link href="/privacy"><a>Privacy Policy</a></Link></p><br/>
                            <p className="text-xxs text-bold"><Link href="/contact"><a>Contact</a></Link></p><br/>
                            <p className="text-xxs text-bold"><Link href="/terms"><a>Terms &amp; Conditions</a></Link></p>
                        </div>
                        <div className="col-md-3 links">
                            <p className="text-xxs text-bold"><Link href="/customers"><a>Customers</a></Link></p><br/>
                            <p className="text-xxs text-bold"><Link href="/about"><a>About</a></Link></p><br/>
                            <p className="text-xxs text-bold"><Link href="/careers"><a>Careers</a></Link></p>
                        </div>
                    </div>
                    ...
                    <div className="text-center">
                        <p className="text-xxs text-bold">© 2021 <Link href="/"><a>Aytaro</a></Link>, All rights reserved.</p>
                    </div>
                </footer>
            </div>
        </div>
